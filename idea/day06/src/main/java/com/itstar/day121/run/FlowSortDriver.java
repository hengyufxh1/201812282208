...
public class FlowSortDriver {
    ...
    public static void main(String [] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        // 7.设置输出输入的路径
        FileInputFormat.setInputPaths(job, new Path("E:\\localhost_201811230927_IDEAMyTest\\project\\day06\\out"));
        // 8.设置数据输出的路径
        FileOutputFormat.setOutputPath(job, new Path("E:\\localhost_201811230927_IDEAMyTest\\project\\day06\\out1"));
        // 9. 提交任务
